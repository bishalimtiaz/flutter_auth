abstract class AuthValues {
  ...
  static const int otpResendTimeInSecond = 20;
  static const double defaultLayoutWidth = 390;
  static const double defaultLayoutHeight = 844;
}
