...
import 'constants/loader_values.dart';
        ...
        child: Stack(
          children: List.generate(delays.length, (index) {
            ...
            return Positioned.fill(
              ...
              top: _position,
              child: Transform(
                transform: Matrix4.rotationZ(LoaderValues.rotationAngle *
                    index *
                    LoaderValues.rotationConstant),
                child: Align(
                  ...
                  child: ScaleTransition(
                    ...
                    child: SizedBox.fromSize(
                        size:
                            Size.square(widget.size * LoaderValues.squareSize),
